...
export default function TeamSelect({ optionsList, columnOptions, onChange }: TeamSelectProps) {
  const [selectedTeams, setSelectedTeams] = useState<string[]>([]);
  const [selectedColumns, setSelectedColumns] = useState<string[]>(["Player", "Name", "Number"]);
      ...
      <div className="space-y-6">
        ...
        <div>
          <MultiSelect
            ...
            defaultSelected={["Player", "Name", "Number"]}
